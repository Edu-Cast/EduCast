    ...
    <AuthShell mode="login">
      <div className="ec-card-dashed w-full max-w-[520px] px-5 py-6 backdrop-blur-[1px] sm:px-7 sm:py-8 lg:px-8 lg:py-9">
        ...
        <p className="mt-1 text-center text-[14px] text-[#1f2e5d] sm:text-[17px] lg:text-[20px]">
          No account yet?{" "}
          <Link href="/register" className="underline underline-offset-2 hover:text-[#14296d]">
            Sign up
          </Link>
        </p>

        <form action="/api/auth/login" method="post" className="mt-6 space-y-3 sm:mt-7 sm:space-y-4">
          ...
          >
            Sign in <IconPlay className="h-4 w-4 sm:h-5 sm:w-5" />
          </button>
        </form>
      </div>
    </AuthShell>
